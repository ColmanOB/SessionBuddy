  ...
  public static void main(String[] args) throws URISyntaxException {
    try {
      ...
      for (int i = 0; i < resultSet.size(); i++) {
        System.out.println(
            "Tune ID: " + resultSet.get(i).tuneDetails.generalTuneDetails.basicTuneDetails.tuneID);
        System.out.println("Tune Name: "
            + resultSet.get(i).tuneDetails.generalTuneDetails.basicTuneDetails.tuneName);
        System.out.println("Tune URL: "
            + resultSet.get(i).tuneDetails.generalTuneDetails.basicTuneDetails.tuneURL);
        System.out.println("No. of Tunebooks: " + resultSet.get(i).tuneDetails.tunebooks);
        System.out.println(
            "Date Submitted: " + resultSet.get(i).tuneDetails.generalTuneDetails.submittedDate);
        System.out
            .println("Tune Type: " + resultSet.get(i).tuneDetails.generalTuneDetails.tuneType);
