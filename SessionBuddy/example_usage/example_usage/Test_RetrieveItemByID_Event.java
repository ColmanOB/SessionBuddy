  ...
  public static void main(String[] args) throws URISyntaxException {
    try {
      ...
      for (int i = 0; i < (resultSet.comments.size()); i++) {
        ...
        System.out
            .println("Comment Submitter Username: " + resultSet.comments.get(i).member.userName);
        System.out
            .println("Comment Submitter Profile Page: " + resultSet.comments.get(i).member.userURL);
