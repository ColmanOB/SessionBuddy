...
public class RecordingsSearchParser 
	...
	private RecordingsSearchResultWrapper listOfResults;	
	 ...
	 */
	public RecordingsSearchResultWrapper parseResponse(String searchResultsString) 
		{
		// TODO: Add exception handling	
		Gson gson = new GsonBuilder().create();
		
		listOfResults = gson.fromJson(searchResultsString, RecordingsSearchResultWrapper.class);
