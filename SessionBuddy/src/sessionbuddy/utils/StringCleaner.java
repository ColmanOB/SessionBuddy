...
public class StringCleaner {
  /**
   * An iterative method to catch any XML entities in the response from the API and replace them
   * with their standard characters.
   * 
   * This is tricky because the API is not always consistent in how it returns XML entities. e.g. an
   * ampersand may be returned as "&amp;", "&#038;", "&#38;", or even an unescaped & character
   * 
  ...
  public static String cleanString(final String inputString) {
    ...
    // Iterate through each character of the input string, and look for anything starting with an &
    // character
    while (i < inputLength) {
