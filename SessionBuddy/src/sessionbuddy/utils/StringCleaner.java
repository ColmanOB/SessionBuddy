...
public class StringCleaner {
  /**
   * Catch any XML entities in the response from the API and replace them with their standard
   * characters.
   * 
  ...
  public static String cleanString(final String inputString) {
    ...
    // Iterate through each char of the string, looking for anything starting with an &
    while (i < inputLength) {
