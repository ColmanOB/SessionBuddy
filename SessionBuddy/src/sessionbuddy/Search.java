...
/**
 * A superclass of the KeywordSearch, LatestSearch and LocationSearch classes. This class is
 * unlikely to ever be instantiated directly - it just holds common fields and methods shared by the
 * three subclasses.
 * 
 * @author Colman
 * @since 2017-09-06
...
public class Search {
  ...
  /**
   * Helper method to validate that the user has specified a value between 1-50 for the results per
   * page
   * 
   ...
   * @throws IllegalArgumentException if a value of zero or less, or a value of more than 50 was
   *         provided
   */
  protected static boolean validateResultsPerPageCount(int resultsPerPage)
