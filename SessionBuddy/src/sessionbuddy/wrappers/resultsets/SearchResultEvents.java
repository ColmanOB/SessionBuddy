...
/**
 * A structure to hold an individual event from a set of search results from thesession.org API. The
 * search may be a keyword-based search or a search for recently-added events
 * 
 * @author Colman O'B
 * @since 2018-01-28
 */
public class SearchResultEvents {
   ...
   * @param schedule an EventSchedule object populated with the start and date date/time of the
   *        event
   ...
   */
  public SearchResultEvents(EventDetails details, User user, EventSchedule schedule,
      Coordinates coordinates, Venue venue, Town town, Area area, Country country) {
