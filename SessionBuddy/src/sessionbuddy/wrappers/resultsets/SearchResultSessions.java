 ...
 * search may be a keyword-based search or a search for recently-added sessions
 * 
 * @author Colman O'B
 * @since 2018-01-28
 */
public class SearchResultSessions {
   ...
   * @param user a User object that has already been populated with the details of the session
   *        submitter
   ...
   */
  public SearchResultSessions(SessionDetails details, Coordinates coordinates, User user,
      Venue venue, Town town, Area area, Country country) {
