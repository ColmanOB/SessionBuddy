...
/**
 * A wrapper for the result returned when retrieving an individual discussion by its ID. Holds
 * meta-details of the discussion, details of the user who submitted the discussion, and the
 * comments within the dicussion
 * 
 * @author Colman
 * @since 2017-12-29
 */
public class ItemResultDiscussion {
   ...
   * @param comments A Comment object populated with the details of an individual comment within the
   *        dicussion
   */
  public ItemResultDiscussion(DiscussionDetails discussionDetails, User member,
