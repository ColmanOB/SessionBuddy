...
/**
 * A wrapper for the result returned when retrieving an individual event by its ID. Holds metadata
 * relating to the event, its schedule, its location, and any comments on the event's page
 * 
 * @author Colman
 * @since 2017-12-29
 */
public class ItemResultEvent {
   ...
   */
  public ItemResultEvent(EventDetails eventDetails, User member, EventSchedule schedule,
