...
/**
 * A structure to represent an individual result from a search for the latest tune sets submitted to thesession.org
 * 
 * @author Colman O'B
 * @since 2018-01-28
 *
 */
public class LatestSearchSets 
	{
	/**
	 ...
	 */
	public LatestSearchSets(LatestSetDetails setDetails, User submitter)
		{
