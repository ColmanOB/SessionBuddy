...
/**
 * A structure to hold an individual tune from a set of search results. This can only be used for
 * keyword-based searches - searches for recently added tunes return results in a totally different
 * format
 * 
 * @author Colman O'B
 * @since 2017-09-17
