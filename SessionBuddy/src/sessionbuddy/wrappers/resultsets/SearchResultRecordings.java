...
/**
 * A structure to hold an individual recording listing from a set of search results The search may
 * be a keyword-based search or a search for recently-added recordings
 * 
 * @author Colman O'B
 * @since 2018-01-28
 */
