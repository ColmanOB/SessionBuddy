...
public class ItemResultSession {
   ...
   * @param schedule an ArrayList of Strings representing the days of the week that the session
   *        takes place
   * @param comments an ArrayList of Comment objects that have already been populated
   */
  public ItemResultSession(SessionDetails sessionDetails, Coordinates coordinates, User member,
      Venue venue, Town town, Area area, Country country, ArrayList<String> schedule,
