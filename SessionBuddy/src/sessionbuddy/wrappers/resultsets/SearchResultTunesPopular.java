...
/**
 * A structure to represent an individual result from a search for the latest tunes submitted to
 * thesession.org
 * 
 * @author Colman O'B
 * @since 2018-01-28
...
public class SearchResultTunesPopular {
   ...
   */
  public SearchResultTunesPopular(TuneDetailsWithDateAndTunebooks tuneDetails, User submitter) {
