...
/**
 * Represents a set of metadata associated with a discussion from thesession.org
 * database. Does not include the actual discussion comments.
 * 
 * @author Colman O'B
 * @since 2017-12-24
 */
public class DiscussionDetails
{
    ...
    /**
     * Constructor method to use when the number of comments is unknown, 
     * e.g. when retrieving a discussion by ID or retrieving discussions submitted by a particular user
     * 
