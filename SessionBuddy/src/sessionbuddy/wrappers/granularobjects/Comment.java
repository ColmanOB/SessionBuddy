 ...
 * It may be a comment on a discussion, a tune, a session etc.
 * 
 * @author Colman
 * @since 2017-12-29
 */
...
{
    /**
     * ID of the particular comment in thesession.org database
     */
    public int id;

    /**
     * The URL of the individual comment
     */
    public String url;
     ...
     * 
     * @param id A numeric ID for the particular comment within thesession.org database
