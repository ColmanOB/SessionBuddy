...
/**
 * Represents an individual tune setting returned when searching for a list of
 * newest tune settings.
 * 
 * It is important to note that this data is returned in a different format when
 * compared to that returned when searching for a tune by name or ID etc.
 * 
 * @author Colman O'B
 * @since 2017-12-29
 */
...
{
    /**
     * A numeric ID for the tune setting in thesession.org database
     */
     ...
     * 
     * @param settingID A numeric ID for the individual tune setting in thesession.org database
