 ...
 * @since 2018-01-28
 */
public class SearchResultSingleSession
{
    /**
     ...
     */
    public SearchResultSingleSession(SessionDetails details, Coordinates coordinates, User user, Venue venue, Town town, Area area, Country country)
    {
