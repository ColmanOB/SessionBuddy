...
/**
 * A wrapper class for the response returned when searching for the most recently added sets of tunes on thesession.org.
 * The fields and nested structure follow the format of the JSON structure of the most recent sets results from the API.
 * 
