...
/**
 * A wrapper class for a tune entry, including the list of settings of one
 * particular tune returned from thesession.org API. 
 * The fields and nested structure follow the JSON structure of the search results.
 * 
 * @author Colman
 * @since 2018-02-01
 */
public class ItemWrapperTune
{
    ...
    /**
     * The number of recordings in thesession.org database with a tune of this name
     */
    ...
    /**
     * A wrapper for the details a thesession.org user. This may be the user who
     * submitted the tune itself, or who submitted a particular setting.
     * 
     * @author Colman
     * @since 2018-02-01
     */
