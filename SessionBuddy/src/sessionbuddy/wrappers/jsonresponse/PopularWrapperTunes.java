...
/**
 * A wrapper class for the response returned when searching for the most popular tunes on thesession.org.
 * As far as I know, the popularity of a tune is determined by the number of user tunebooks on thesession.org to which it has been added.
 * The fields and nested structure follow the format of the JSON structure of the most popular tunes results from the API.
 * 
