...
/**
 * A wrapper class for the response returned from the API at
 * https://thesession.org when searching for a session by geographic location.
 * The fields and nested structure follow the format of the JSON structure of
 * the session search results from the API
 * 
 * @author Colman O'B
 * @since 2017-08-22
 */
...
{
    public String latlon; // Latitude and longitude specified in the request,
                          // separated by a comma
    public String radius; // No. of Km radius to include around the specified
                          // coordinates
    public String format; // Format of the results (should always be JSON for
                          // this project)
    public String pages; // Number of pages in the result set
    public String page; // Current page number within the result set
    public sessionsList[] sessions; // An array of the individual sessions
                                    // returned
    ...
    public class sessionsList
    {
        ...
        public SubmitterDetails member; // Details of thesession.org user who
                                        // submitted the session
        ...
        public TownDetails town; // Details of the town where the session is
                                 // located
        public AreaDetails area; // Details of the geographic area in which the
                                 // session is located
        public CountryDetails country; // Details of the country in which the
                                       // session is located
        ...
        public class SubmitterDetails
        {
            ...
            public String url; // URL of the member's profile page on
                               // thesession.org
        }
