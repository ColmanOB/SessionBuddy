...
public class ItemWrapperEvent
{
    ...
    /**
     * A wrapper for the details of the "town" within each "event" in the result
     * set
     * 
     * @author Colman O'B
     * @since 2018-01-28
    ...
    /**
     * A wrapper for the details of the "area" within each "event" in the result
     * set
     * 
     * @author Colman O'B
     * @since 2018-01-28
    ...
    /**
     * A wrapper for the details of the "country" within each "event" in the
     * result set
     * 
     * @author Colman O'B
     * @since 2018-01-28
