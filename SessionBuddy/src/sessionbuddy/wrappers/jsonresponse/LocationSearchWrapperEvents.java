...
{
    public String latlon; // The latitude and longitude specified in the
                          // request, separated by a comma
    ...
    public eventsList[] events; // An array of the individual events returned by
                                // the search
    ...
    public class eventsList
    {
        ...
        public TownDetails town; // Details of the town where the event is
                                 // located
        ...
        {
            public int id; // ID of the member of thesession.org who submitted
                           // the event
            public String name; // Username of the submitter
            public String url; // URL of the submitter's profile page on
                               // thesession.org
        }
