...
/**
 * A wrapper class for the response returned when searching by keyword for a tune from the API at
 * https://thesession.org The fields and nested structure follow the format of the JSON structure of
 * the tune search results from the API
 * 
 * @author Colman O'B
 * @since 2017-01-26
 */
