...
/**
 * A wrapper class for a trip listing. The fields and nested structure follow the format of the JSON
...
public class ItemWrapperTrip {
  ...
  /**
   * A wrapper for the details of thesession.org user who submitted the trip
   * 
   * @author Colman
   * @since 2018-12-11
   */
