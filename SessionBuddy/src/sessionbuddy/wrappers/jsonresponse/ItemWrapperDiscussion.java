...
/**
 * A wrapper class for the result set when retrieving an individual discussion by its ID. For an
 * example of the response structure, see https://thesession.org/discussions/26115?format=json The
 * fields and nested structure here follow the JSON structure of the response.
 * 
 * @author Colman O'B
 * @since 2018-01-28
 */
