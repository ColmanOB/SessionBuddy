...
/**
 * A wrapper class for the JSON response returned from the API at https://thesession.org when
 * searching for discussions by keyword(s). The fields and nested structure follow the format of the
 * JSON structure of the recordings search results from the API
 * 
 * @author Colman O'B
 * @since 2018-02-01
 */
