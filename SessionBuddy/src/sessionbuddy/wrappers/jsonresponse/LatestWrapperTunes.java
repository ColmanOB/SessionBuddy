...
/**
 * A wrapper class for the response returned when searching for the most recently added tunes on
 * thesession.org. The fields and nested structure follow the format of the JSON structure of the
 * latest tunes results from the API.
 * 
 * Note that this wrapper is an anomaly - for all other data categories the response is the same for
 * a keyword search and for latest listings. Latest tunes are presented quite differently from the
 * results of a keyword search for tunes.
 * 
 * @author Colman O'B
 * @since 2017-09-06
 */
public class LatestWrapperTunes {
  ...
  public SettingDetails[] settings; // An array of the individual tune settings returned by the
                                    // search
