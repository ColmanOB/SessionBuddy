...
public class PopularSearchTest {
  ...
  @Test
  public void testGetTunesWithPageNumberAndResultsPerPage()
    ...
    for (int i = 0; i < resultSet.size(); i++) {
      assertThat(resultSet.get(i).tuneDetails.generalTuneDetails.basicTuneDetails.tuneID,
          is(notNullValue()));
      assertThat(resultSet.get(i).tuneDetails.generalTuneDetails.basicTuneDetails.tuneName,
          is(notNullValue()));
      assertThat(resultSet.get(i).tuneDetails.generalTuneDetails.basicTuneDetails.tuneURL,
          is(notNullValue()));
  ...
  @Test
  public void testGetTunesWithNoPageNumberButResultsPerPage()
      throws IllegalArgumentException, IOException, URISyntaxException {
    int resultsPerPage = 50;
  ...
  @Test
  public void testAttemptWithNegativeResultsPerPage()
      throws IllegalArgumentException, IOException, URISyntaxException {
    negativeItemsPerPageException.expect(IllegalArgumentException.class);
    negativeItemsPerPageException
        .expectMessage("Number of results per page must be greater than zero");
