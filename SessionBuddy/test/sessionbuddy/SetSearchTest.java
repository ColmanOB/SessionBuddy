...
public class SetSearchTest {
  ...
  @Test
  public void testAttemptWithLessThanZeroResultsPerPage()
      throws IllegalArgumentException, IOException, URISyntaxException {
  ...
  @Test
  public void testAttemptWithMoreThanFiftyResultsPerPage()
      throws IllegalArgumentException, IOException, URISyntaxException {
  ...
  @Test
  public void testAttemptWitNegativePageNumber()
      throws IllegalArgumentException, IOException, URISyntaxException {
    NegativePageNumberException.expect(IllegalArgumentException.class);
    NegativePageNumberException
        .expectMessage("Page number must be an integer value greater than zero");
  ...
  @Test
  public void testAttemptWitNegativePageNumberAndNegativeItemsPerPage()
      throws IllegalArgumentException, IOException, URISyntaxException {
    NegativePageNumberException.expect(IllegalArgumentException.class);
  ...
  @Test
  public void testAttemptWithPositivePageNumberAndNegativeItemsPerPage()
      throws IllegalArgumentException, IOException, URISyntaxException {
    negativeItemsPerPageException.expect(IllegalArgumentException.class);
