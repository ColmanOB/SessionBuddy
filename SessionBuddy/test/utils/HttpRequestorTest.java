...
public class HttpRequestorTest {
  // A simple test to ensure that HttpRequestor returns a JSON response containing some expected
  // text
  ...
  public void testHttpResponse() {
    // A known good URL that should retrieve the details of the tune with ID 2, i.e. The Bucks of
    // Oranmore
    ...
    try {
      ...
      // Invoke the method to be tested, passing in the 'known good' URL, and store the JSON
      ...
      // Catch a HTTP failure response, timeout etc. as well as a response not containing substring
      // "Bucks Of Oranmore"
      fail(e.getMessage());
    }
  }
