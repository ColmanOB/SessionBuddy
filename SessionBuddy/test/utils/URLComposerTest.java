...
/**
 * Tests the UrlBuilder class to ensure it constructs the API URL in the correct format, based on
...
public class URLComposerTest {
  ...
  public void testItemRetrieverURL() {
    ...
    URL requestURL = ub.new Builder().requestType(RequestType.SINGLE_ITEM)
  ...
  public void testKeywordSearchURLWithPaginationAndItemsPerPage() {
    ...
    URL requestURL = ub.new Builder().requestType(RequestType.SEARCH_BY_KEYWORD)
        .path("discussions" + "/" + "search").queryParameters(queryParams)
        .itemsPerPage(resultsPerPage).pageNumber(pageNumber).build();

    assertEquals(
        "https://thesession.org/discussions/search?q=wig+glue&format=json&perpage=5&page=2",
        requestURL.toString());
  }
  ...
  public void testKeywordSearchURLWithPaginationButNoItemsPerPageSpecified() {
    ...
    URL requestURL = ub.new Builder().requestType(RequestType.SEARCH_BY_KEYWORD)
        .path("discussions" + "/" + "search").queryParameters(queryParams).pageNumber(pageNumber)
        .build();

    assertEquals("https://thesession.org/discussions/search?q=wig+glue&format=json&page=2",
        requestURL.toString());
  }
  ...
  public void testKeywordSearchURLWithoutPaginationOrItemsPerPage() {
    ...
    URL requestURL = ub.new Builder().requestType(RequestType.SEARCH_BY_KEYWORD)
        .path("discussions" + "/" + "search").queryParameters(queryParams).build();

    assertEquals("https://thesession.org/discussions/search?q=wig+glue&format=json",
        requestURL.toString());
  }
  ...
  public void testKeywordSearchURLWithoutPaginationButWithItemsPerPage() {
    ...
    assertEquals("https://thesession.org/discussions/search?q=wig+glue&format=json&perpage=5",
        requestURL.toString());
  }
  ...
  public void testLatestSearchURLWithoutPaginationButWithItemsPerPage() {
    ...
    URL requestURL = ub.new Builder().requestType(RequestType.SEARCH_LATEST_ITEMS)
  ...
  public void testLatestSearchURLWithPaginationAndItemsPerPage() {
    ...
    assertEquals("https://thesession.org/tunes/new?format=json&perpage=5&page=2",
        requestURL.toString());
  }
  ...
  public void testLocationSearchURLWithoutPaginationButWithItemsPerPage() {
    ...
    URL requestURL = ub.new Builder().requestType(RequestType.SEARCH_BY_LOCATION)
        .path(dataCategory + "/" + "nearby").queryParameters(queryParams)
        .itemsPerPage(resultsPerPage).build();

    assertEquals(
        "https://thesession.org/sessions/nearby?latlon=53.3498%2C6.2603&radius=100&format=json&perpage=5",
        requestURL.toString());
  }
  ...
  public void testLocationSearchURLWithPaginationAndItemsPerPage() {
    ...
    assertEquals(
        "https://thesession.org/sessions/nearby?latlon=53.3498%2C6.2603&radius=100&format=json&perpage=5&page=2",
        requestURL.toString());
  }
  ...
  public void testMemberContributionSearchURLWithoutPaginationButWithItemsPerPage() {
    ...
    URL requestURL = ub.new Builder().requestType(RequestType.SEARCH_MEMBER_CONTRIBUTIONS)
        .path("members" + "/" + userID + "/" + dataCategory).itemsPerPage(resultsPerPage).build();

    assertEquals("https://thesession.org/members/1/tunes?format=json&perpage=5",
        requestURL.toString());
  }
  ...
  public void testMemberContributionSearchURLWithPaginationAndItemsPerPage() {
    ...
    assertEquals("https://thesession.org/members/1/tunes?format=json&perpage=5&page=2",
        requestURL.toString());
  }
  ...
  public void testPopularSearchURLWithoutPaginationButWithItemsPerPage() {
    ...
    URL requestURL = ub.new Builder().requestType(RequestType.SEARCH_POPULAR)
        .path("tunes" + "/" + "popular").itemsPerPage(resultsPerPage).build();

    assertEquals("https://thesession.org/tunes/popular?format=json&perpage=5",
        requestURL.toString());
  }
  ...
  public void testPopularSearchURLWithPaginationAndItemsPerPage() {
    ...
    URL requestURL =
        ub.new Builder().requestType(RequestType.SEARCH_POPULAR).path("tunes" + "/" + "popular")
            .itemsPerPage(resultsPerPage).pageNumber(pageNumber).build();

    assertEquals("https://thesession.org/tunes/popular?format=json&perpage=5&page=2",
        requestURL.toString());
  }
  ...
  public void testSetSearchURLWithoutPaginationButWithItemsPerPage() {
    ...
    URL requestURL = ub.new Builder().requestType(RequestType.SEARCH_SETS)
        .path("tunes" + "/" + "sets").itemsPerPage(resultsPerPage).build();
  ...
  public void testSetSearchURLWithPaginationAndItemsPerPage() {
    ...
    URL requestURL = ub.new Builder().requestType(RequestType.SEARCH_SETS)
        .path("tunes" + "/" + "sets").itemsPerPage(resultsPerPage).pageNumber(pageNumber).build();

    assertEquals("https://thesession.org/tunes/sets?format=json&perpage=5&page=2",
        requestURL.toString());
  }
}
