...
/**
 * Tests the UrlBuilder class to ensure it constructs the API URL 
 * in the correct format based on the data being requested
 * 
 * The programmatically constructed URL is compared to a 'known good'
 * URL for the API call in question
 * 
 * @author Colman
 * @since 2018-04-01
 */
public class URLComposerTest
{
    ...
    public void testKeywordSearchURLWithoutPaginationOrItemsPerPage()
    {
        ...
        assertEquals(
                "https://thesession.org/discussions/search?q=wig+glue&format=json",
                requestURL.toString());
    }
    ...
    public void testKeywordSearchURLWithoutPaginationButWithItemsPerPage()
    {
        ...
        assertEquals(
                "https://thesession.org/discussions/search?q=wig+glue&format=json&perpage=5",
                requestURL.toString());
    }
    ...
    public void testLatestSearchURLWithoutPaginationButWithItemsPerPage()
    {
        ...
        URL requestURL = ub.new Builder()
                ...
                .path(dataCategory + "/" + "new").itemsPerPage(resultsPerPage)
                .build();

        assertEquals("https://thesession.org/tunes/new?format=json&perpage=5",
                requestURL.toString());
    }
    ...
    public void testLatestSearchURLWithoutPaginationOrItemsPerPage()
    {
        ...
        assertEquals("https://thesession.org/tunes/new?format=json",
                requestURL.toString());
    }
    ...
    public void testLatestSearchURLWithPaginationAndItemsPerPage()
    {
        ...
        assertEquals(
                "https://thesession.org/tunes/new?format=json&perpage=5&page=2",
                requestURL.toString());
    }
    ...
    public void testLocationSearchURLWithoutPaginationButWithItemsPerPage()
    {
        ...
        List<NameValuePair> queryParams = new ArrayList<>();
        queryParams.add(
                new BasicNameValuePair("latlon", latitude + "," + longitude));
    ...
    public void testMemberContributionSearchURLWithoutPaginationButWithItemsPerPage()
    {
        ...
        assertEquals(
                "https://thesession.org/members/1/tunes?format=json&perpage=5",
                requestURL.toString());
    }
    ...
    public void testMemberContributionSearchURLWithPaginationAndItemsPerPage()
    {
        ...
        assertEquals(
                "https://thesession.org/members/1/tunes?format=json&perpage=5&page=2",
                requestURL.toString());
    }
    ...
    public void testPopularSearchURLWithoutPaginationButWithItemsPerPage()
    {
        ...
        URL requestURL = ub.new Builder()
                ...
                .path("tunes" + "/" + "popular").itemsPerPage(resultsPerPage)
                .build();

        assertEquals(
                "https://thesession.org/tunes/popular?format=json&perpage=5",
                requestURL.toString());
    }
    ...
    public void testPopularSearchURLWithPaginationAndItemsPerPage()
    {
        ...
        assertEquals(
                "https://thesession.org/tunes/popular?format=json&perpage=5&page=2",
                requestURL.toString());
    }
    ...
    public void testSetSearchURLWithoutPaginationButWithItemsPerPage()
    {
        ...
        URL requestURL = ub.new Builder().requestType(RequestType.SEARCH_SETS)
                .path("tunes" + "/" + "sets").itemsPerPage(resultsPerPage)
                .build();

        assertEquals("https://thesession.org/tunes/sets?format=json&perpage=5",
                requestURL.toString());
    }
    ...
    public void testSetSearchURLWithPaginationAndItemsPerPage()
    {
        ...
        assertEquals(
                "https://thesession.org/tunes/sets?format=json&perpage=5&page=2",
                requestURL.toString());
    }
}
